...
to become-infected
  ...
  set infectious-competitive tents with [infected? and (attitude = "competitive" or attitude = "new-competitive")]
  if any? tents with [infected? and (attitude = "competitive" or attitude = "new-competitive")] [set nbr-infectious-competitive count infectious-competitive]

  set infectious-cooperative tents with [infected? and attitude = "cooperative"]
  if any? tents with [infected? and attitude = "cooperative"] [set nbr-infectious-cooperative count infectious-cooperative]
...
create-COVID-facility</setup>
  ...
  <experiment name="E88_BaselineS2_withinfectionlocations" repetitions="1" runMetricsEveryStep="true">
    <setup>setup
initiate-corona
create-COVID-facility</setup>
    <go>go</go>
    ...
    <metric>averageQueueSize_serving_output</metric>
    <metric>averageQueueSize_physical_output</metric>
    <metric>infection-locations-coordinates</metric>
    <metric>infection-locations-activity</metric>
    <metric>infections-provoked-cooperative</metric>
    <metric>infections-provoked-competitive</metric>
  ...
  <experiment name="E99" repetitions="1" runMetricsEveryStep="true">
...
create-COVID-facility</setup>
    ...
    <metric>infection-locations-coordinates</metric>
    <metric>infection-locations-activity</metric>
    <metric>attitude-infectee</metric>
    <metric>infection-locations-activity-previous</metric>
    <metric>attitude-infector</metric>
    ...
    <metric>max_queuing_time_cooperative</metric>
    <metric>min_queuing_time_cooperative</metric>
    <metric>max_queuing_time_competitive</metric>
    <metric>min_queuing_time_competitive</metric>
    <metric>max_queuing_time_newcompetitive</metric>
    <metric>min_queuing_time_newcompetitive</metric>
    <metric>attitude-and-infections</metric>
    <metric>attitude-and-timeinqueue</metric>
    <enumeratedValueSet variable="initial-corona-number">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="policy-implemented">
